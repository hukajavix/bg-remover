...
const Upload = () => {
  return (
    <div className="pb-16">
      {/* --------------Title----------- */}
      <h1 className="text-center text-2xl md:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent py-6 md:py-16">
        See magic. You wanna try it?
      </h1>
